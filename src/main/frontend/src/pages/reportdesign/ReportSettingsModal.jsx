                ...
                <Modal animation={false} 
                    ...
                    <Modal.Body>
                        <div className="entrygrid-125-100">
                            ...
                            <div className="label">{getText("Border Top:")}</div><div><NumberEntry id="bt" name="borderTop" defaultValue={pageSettings.borderTop} min={0} onChange={e => onPageSettings(e)} /></div>
